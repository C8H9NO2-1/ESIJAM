 ...
 */
void chargerTextureEntite(texture_entite **ptE, const char *fichierUnite, const char *fichierPiege, SDL_Renderer *renderer); //! Il sera peut être nécessaire de passer un seul fichier en paramètre, dépendant de comment Tym fait les fichiers
